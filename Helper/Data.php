 ...
 */
namespace Lof\LowStockNotification\Helper;
...
/**
 * Class Data
 * @package Lof\LowStockNotification\Helper
 */
class Data extends AbstractHelper
{
    ...
    const LOW_STOCK_SINGLE_ALERT_TEMPLATE_FILE =
                    'Lof_LowStockNotification::notifications/low_stock_single_alert.phtml';

    const LOW_STOCK_ALERT_TEMPLATE_FILE = 'Lof_LowStockNotification::notifications/low_stock_alert.phtml';
